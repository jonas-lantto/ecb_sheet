...
class Currency_rateTest < Minitest::Test
  ...
  def test_all_data_available
    ...
    t = cr.table_data_currency2rate('2014-11-21', 'GBP')
    ...
    t = cr.table_data_date2rate('EUR', 'GBP')
